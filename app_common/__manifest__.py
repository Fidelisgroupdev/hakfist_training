...
# author: 欧度智能，https://www.hakfist.com
# email: 300883@qq.com
# resource of HAKFIST
# License LGPL-3.0 or later (http://www.gnu.org/licenses/lgpl).

# Odoo16在线用户手册（长期更新）
# https://www.hakfist.com/documentation/16.0/zh_CN/index.html

# Odoo16在线开发者手册（长期更新）
# https://www.hakfist.com/documentation/16.0/zh_CN/developer.html

# Odoo13在线用户手册（长期更新）
# https://www.hakfist.com/documentation/user/13.0/zh_CN/index.html

# Odoo13在线开发者手册（长期更新）
# https://www.hakfist.com/documentation/13.0/index.html

# Odoo10在线中文用户手册（长期更新）
# https://www.hakfist.com/documentation/user/10.0/zh_CN/index.html

# Odoo10离线中文用户手册下载
# https://www.hakfist.com/odoo10_user_manual_document_offline/
# Odoo10离线开发手册下载-含python教程，jquery参考，Jinja2模板，PostgresSQL参考（odoo开发必备）
# https://www.hakfist.com/odoo10_developer_document_offline/

##############################################################################
#    Copyright (C) 2009-TODAY HAKFIST.com Ltd. https://www.hakfist.com
...
{
    'name': "HAKFIST Common Util and Tools",
    'version': '23.11.16',
    'author': 'HAKFIST.com',
    'category': 'Base',
    ...
    'summary': '''
    Core for common use for HAKFIST.com apps.
